...
class UI {
    ...
    ocultarTodasLasSecciones() {
        ...
        document.getElementById('ParcialNoLineal').style.display = 'none'; // Ocultar sección de Dijkstra
    ...
    inicializarEventos() {
        ...
        document.getElementById('parcialNoLinealButton').addEventListener('click', () => {
            this.ocultarTodasLasSecciones();
            document.getElementById('ParcialNoLineal').style.display = 'block'; // Mostrar sección de Dijkstra
        });
